...
import { BriefcaseIcon, Lock, Mail, User, Loader2 } from "lucide-react";
...
const SignupPage = () => {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    if (credentialResponse.credential) {
      const success = await googleLogin(credentialResponse.credential, true);
      if (success) navigate("/");
    }
  };

  const handleGoogleError = () => {
    toast.error("Google sign-up failed or was closed");
  };
        ...
        <div className="card-body p-8">
          ...
          <div className="flex flex-col items-center gap-2 mb-4 text-center">
            ...
            <p className="text-sm text-base-content/70">
              Start tracking all your job & internship applications
            </p>
          </div>
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <input
                  ...
                  required
                />
                <User className="size-4.5 absolute left-3 top-1/2 -translate-y-1/2 text-base-content/40" />
              </div>
            </div>
